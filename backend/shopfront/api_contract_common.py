"""Shared payload builders for storefront contract APIs."""
...
def money(value: object) -> str:
    """Normalize money-like values to a stable string contract."""
...
def normalize_product_card(raw: dict[str, object]) -> dict[str, object]:
    """Validate/normalize card from remote services for stable API responses."""
    return {
