...
`shopfront.searching.service` chooses providers and fallback strategy. This module
...
def _norm_query(query: str) -> str:
    """Internal helper for norm query."""
