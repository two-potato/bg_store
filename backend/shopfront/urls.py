...
from .views import (
    ...
    BrandsPageView, BrandDetailPageView, PromotionsPageView, BlogPageView,
    FavoritesPageView, FavoriteToggleView, SavedSearchesPageView,
    ...
    SellerStoreDetailView, SellerProfileView, SellerStoreLegacyRedirectView,
    FakePaymentPageView,
...
urlpatterns = [
    ...
    path("brands/<int:brand_id>/", BrandDetailPageView.as_view(), name="brand_detail"),
